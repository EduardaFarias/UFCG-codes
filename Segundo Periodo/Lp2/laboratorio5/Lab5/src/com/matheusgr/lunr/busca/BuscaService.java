...
public class BuscaService {
	 ...
	 */
	public DocumentoDTO[] busca(Busca buscaProcurado) {
		Map<Documento, Integer> respostaDocumento = buscaProcurado.busca(this.ds);
		DocumentoDTO[] documentos = ordena(respostaDocumento);
		this.br.adicionaBusca(buscaProcurado, documentos);
		return documentos;  
	}
