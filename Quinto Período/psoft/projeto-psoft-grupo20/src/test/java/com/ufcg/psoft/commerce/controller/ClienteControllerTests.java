...
public class ClienteControllerTests {
    ...
    class ClienteVerificacaoNome {
        ...
        void quandoAlteramosNomeDoClienteValido() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(put(URI_CLIENTES + "/" + cliente.getId() + "/put")
    ...
    class ClienteVerificacaoFluxosBasicosApiRest {
        ...
        void quandoBuscamosPorTodosClienteSalvos() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(get(URI_CLIENTES + "/get-all")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(clientePostPutRequestDTO)))
        ...
        void quandoBuscamosPorUmClienteSalvo() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(get(URI_CLIENTES + "/" + cliente.getId() + "/get-one")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(clientePostPutRequestDTO)))
                    .andExpect(status().isOk()) // Codigo 200
                    .andDo(print())
        ...
        void quandoBuscamosPorUmClienteInexistente() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(get(URI_CLIENTES + "/" + 999999999 + "/get-one")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(clientePostPutRequestDTO)))
        ...
        void quandoCriarClienteValido() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(post(URI_CLIENTES + "/post")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(objectMapper.writeValueAsString(clientePostPutRequestDTO)))
        ...
        void quandoAlteramosClienteInexistente() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(put(URI_CLIENTES + "/" + 99999L + "/put")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("codigoAcesso", cliente.getCodigoAcesso())
                            .content(objectMapper.writeValueAsString(clientePostPutRequestDTO)))
                    .andExpect(status().isBadRequest()) // Codigo 400
        ...
        void quandoAlteramosClienteCodigoAcessoInvalido() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(put(URI_CLIENTES + "/" + clienteId + "/put")
                            .contentType(MediaType.APPLICATION_JSON)
        ...
        void quandoExcluimosClienteValido() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(delete(URI_CLIENTES + "/" + cliente.getId() + "/delete")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("codigoAcesso", cliente.getCodigoAcesso()))
        ...
        void quandoExcluimosClienteInexistente() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(delete(URI_CLIENTES + "/" + 999999 + "/delete")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("codigoAcesso", cliente.getCodigoAcesso()))
                    .andExpect(status().isBadRequest()) // Codigo 400
                    .andDo(print())
    ...
    class ClienteDemonstrarInteresseEmSabores {
        ...
        void quandoDemonstramosInteresseEmSaborValido() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(put(URI_CLIENTES + "/put/" + cliente.getId() + "/demonstrarInteresse")
                            .contentType(MediaType.APPLICATION_JSON)
        ...
        void quandoDemonstramosInteresseEmSaborCodigoAcessoInvalido() throws Exception {
            ...
            String responseJsonString = driver.perform(put(URI_CLIENTES + "/put/" + cliente.getId() + "/demonstrarInteresse")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("clienteCodigoAcesso", "invalido")
                            .param("saborId", sabor.getId().toString()))
                    .andExpect(status().isBadRequest()) // Codigo 400
                    .andDo(print())
                    .andReturn().getResponse().getContentAsString();
        ...
        void quandoDemonstramosInteresseEmSaborClienteInexistente() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(put(URI_CLIENTES + "/put/999999/demonstrarInteresse")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("clienteCodigoAcesso", cliente.getCodigoAcesso())
                            .param("saborId", sabor.getId().toString()))
                    .andExpect(status().isBadRequest()) // Codigo 400
    ...
    @Nested
    @DisplayName("Conjunto de casos onde um cliente faz um pedido")
    class ClienteFazPedido{
        @Autowired
    ...
    void quandoCriamosUmNovoPedidoComDadosValidos() throws Exception {
        ...
        // Act
        String responseJsonString = driver.perform(post(URI_CLIENTES + "/post/pedido")
                        .contentType(MediaType.APPLICATION_JSON)
