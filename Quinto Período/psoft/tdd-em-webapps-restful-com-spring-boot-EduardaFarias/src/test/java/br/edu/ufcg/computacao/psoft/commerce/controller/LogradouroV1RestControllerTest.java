...
class LogradouroV1RestControllerTest {
    ...
    LogradouroPatchTipoNomeDTO logradouroPatchTipoNomeDTO;
    ...
    @Test
    @DisplayName("Quando buscar todos os logradouros com id válido, Entao todos os logradouros são retornados")
    @DirtiesContext(methodMode = DirtiesContext.MethodMode.BEFORE_METHOD)
