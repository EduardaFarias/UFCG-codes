...
import br.edu.ufcg.computacao.psoft.commerce.service.logradouroService.*;
...
public class LogradouroV1RestController {
    ...
    ResponseEntity<?> atualizarTipoNomeLogradouro(
        ...
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(logradouroAtualizarTipoNomeService.atualizarTipoNome(id, logradouroPatchTipoNomeDTO));
    }
