...
class AssociacaoControllerTests {
    ...
    void setup() {
        ...
        estabelecimento = estabelecimentoRepository.save(Estabelecimento.builder()
                .codigoAcesso("654321")
                .nome("Nturebas Cg")
                .endereco("Rua Maria Aparecida Silva 130- Queimadas")
                .horario("07:30 - 18:00")
                .telefone("3615-0578")
                .build());
    }
    ...
    class EstabelecimentoCriacaoAssociacao {
        ...
        void testCriarAssociacaoComSucesso() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(post(URI_ASSOCIACAO + "/post")
    ...
    class EstabelecimentoAprovacaoAssociacao {
        ...
        void quandoAprovamosAssociacaoComSucesso() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(patch(URI_ASSOCIACAO + "/" + entregador.getId() + "/patch/status/aprovar")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("entregadorId", entregador.getId().toString())
                            .param("estabelecimentoId", estabelecimento.getId().toString())
        ...
        void quandoAprovamosAssociacaoComEntregadorInexistente() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(patch(URI_ASSOCIACAO +"/99999/patch/status/aprovar")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("entregadorId", "9999")
                            .param("estabelecimentoId", estabelecimento.getId().toString())
                            .param("codigoAcessoEstabelecimento", estabelecimento.getCodigoAcesso()))
    ...
    class ClienteReprovacaoAssociacao {
        ...
        void quandoRejeitaAssociacaoComSucesso() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(patch(URI_ASSOCIACAO + "/" + entregador.getId() + "/patch/status/rejeitar")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("entregadorId", entregador.getId().toString())
                            .param("estabelecimentoId", estabelecimento.getId().toString())
                            .param("codigoAcessoEstabelecimento", estabelecimento.getCodigoAcesso()))
        ...
        void quandoRejeitamosAssociacaoComEntregadorInexistente() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(patch(URI_ASSOCIACAO +"/99999/patch/status/rejeitar")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("entregadorId", "9999")
                            .param("estabelecimentoId", estabelecimento.getId().toString())
                            .param("codigoAcessoEstabelecimento", estabelecimento.getCodigoAcesso()))
    ...
    class ClienteAprovacaoAssociacao {
        ...
        void testeRemoverAssociacaoComSucesso() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(delete(URI_ASSOCIACAO + "/" + entregador.getId() + "/delete")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("entregadorId", entregador.getId().toString())
                            .param("codigoAcessoEstabelecimento", estabelecimento.getCodigoAcesso())
                            .param("estabelecimentoId", estabelecimento.getId().toString()))
        ...
        void testCriarRemoverComEntregadorInexistente() throws Exception {
            ...
            // Act
            String responseJsonString = driver.perform(delete(URI_ASSOCIACAO + "/9999/delete")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("entregadorId", "9999")
                            .param("codigoAcessoEstabelecimento", estabelecimento.getCodigoAcesso())
                            .param("estabelecimentoId", estabelecimento.getId().toString()))
        ...
        void testeRemoverAssociacaoComCodigoDeAcessoInvalido() throws Exception {
            ...
            String responseJsonString = driver.perform(delete(URI_ASSOCIACAO + "/" + entregador.getId() + "/delete")
                            .contentType(MediaType.APPLICATION_JSON)
                            .param("entregadorId", entregador.getId().toString())
                            .param("codigoAcessoEstabelecimento", "9999")
                            .param("estabelecimentoId", estabelecimento.getId().toString()))
                    .andExpect(status().isBadRequest())
                    .andDo(print())
                    .andReturn().getResponse().getContentAsString();
